...
import { RedistributionExecutionModal } from '../modals/RedistributionExecutionModal';
...
export const ShortageRiskCard: React.FC<ShortageRiskCardProps> = ({
  ...
  // Example recommendation format from ML service: 
  // "Move 5 units from Ethiopian Red Cross (ERC-HQ)"
  // We'll mock a parse for now, but in a real system this would come structured from the Intelligence API
  const mockRecommendation = {
    hospital_id: 'HOSP-001', 
    hospital_name: 'Ethiopian Red Cross (HQ)',
    recommended_units: 5,
    ...
    <>
      ...
      >
        ...
        <button 
          ...
          className="w-full mt-4 py-2 bg-primary text-on-primary rounded-lg text-sm font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center gap-2 shadow-sm"
        >

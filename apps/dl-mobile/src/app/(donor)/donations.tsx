...
import { donorApi } from "@/src/lib/api";
import { MCard, MBloodTypeBadge, MBadge, MEmptyState } from "@/src/components/ui";
import { formatDate } from "@/src/lib/utils";
import { CheckCircle, Clock, XCircle } from "lucide-react-native";
import { DonationStatus } from "@/src/types/index";
...
const STATUS_ICON: Record<string, React.ReactNode> = {
  ...
  [DonationStatus.DEFERRED]:   <XCircle color="#D32F2F" size={16} />,
};
